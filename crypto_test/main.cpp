...
bool testRsa(bool toModifyMessage)
{
	...
	if (!readRsaKeypair("certificates\\bob.key", "bobkey", "certificates\\bob.crt", &privateKeyContext, &publicKeyContext))
	{
...
int main(int argc, char** argv)
{
	...
	if (testCertificateChecking("certificates\\bob.crt", "certificates\\rootCA.crt", "BOB") && !testCertificateChecking("certificates\\bob.crt", "certificates\\rootCA.crt", "Bobby") && !testCertificateChecking("certificates\\bob.crt", "certificates\\alice.crt", "Bob.com"))
